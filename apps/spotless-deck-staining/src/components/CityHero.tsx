    ...
    <section className="relative min-h-[80vh] flex items-center overflow-hidden pt-20 lg:pt-24">
      <div className="absolute inset-0">
        <Image
          ...
          alt={`Freshly stained cedar deck at a home in ${city.name}, ${city.region} by Spotless Deck Staining`}
          fill
          priority
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {site.trustBadges.map((b) => (
              <div key={b.label} className="flex items-start gap-3">
                <div className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 text-[var(--terracotta)] bg-[#FAF8F3]/95">
