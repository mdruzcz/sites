...
export const metadata = {
  title: "Shop Ready Seal — All Colors & Sizes",
  description:
    "Browse all 9 Ready Seal wood stain & sealer colors in 1 & 5 gallon, plus staining accessories. Oil-based, goof-proof application. Shipped across Ontario from Belmont."
};
