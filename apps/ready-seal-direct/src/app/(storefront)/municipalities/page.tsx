      ...
      <section className="mx-auto max-w-5xl px-4 py-12">
        <div className="grid gap-6 md:grid-cols-3">
          <Pillar
            ...
            body="Issue a PO, receive a Stripe invoice with 30-day terms. No credit card required for municipal orders."
          />
          <Pillar
          ...
          <Pillar
            ...
            body="Need a formal quote for tender? Email us with linear-footage and we&rsquo;ll respond with line-item pricing within 24 hours."
          />
        </div>
      </section>
