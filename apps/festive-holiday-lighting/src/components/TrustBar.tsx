    ...
    <section className="border-b border-[var(--line)] bg-white">
      <div className="shell flex flex-wrap items-center justify-center gap-x-8 gap-y-4 py-5 text-sm text-[var(--ink-soft)]">
        <span className="flex items-center gap-2">
          ...
          <span className="text-[var(--muted)]">({site.reviewCount}+ reviews)</span>
        </span>
        <span className="hidden h-5 w-px bg-[var(--line)] sm:block" />
        <span className="flex items-center gap-2"><ShieldIcon className="w-4 h-4 text-[var(--pine)]" />$5M liability insurance</span>
        <span className="hidden h-5 w-px bg-[var(--line)] sm:block" />
