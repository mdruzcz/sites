...
const localBusinessSchema = {
  ...
  name: site.name,
  description:
    "Professional holiday lighting for homes and businesses in Southern Ontario: classic seasonal Christmas light installation and permanent app-controlled LED roofline systems. Serving Hamilton, Burlington, Oakville, Mississauga, Brampton, Milton, Ancaster, Grimsby, St. Catharines and Niagara Falls.",
  url: site.url,
