      ...
      <section className="bg-cream py-12 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            ...
            <Link href="/services/deck-sealing" className="rounded-lg bg-sand-light/60 px-5 py-3 text-sm font-semibold text-wood-dark transition hover:bg-terracotta hover:text-cream">Deck Sealing</Link>
