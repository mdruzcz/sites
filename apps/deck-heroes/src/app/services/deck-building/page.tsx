  ...
  return (
    <>
      ...
      <section className="relative min-h-[400px] lg:min-h-[500px] flex items-center">
        <Image
          src="/images/modern-house-deck.jpg"
          alt="Custom deck building by Deck Heroes — expert craftsmanship in Ontario"
          fill
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-2xl">
            ...
            <p className="mt-6 max-w-xl text-lg text-white/85">
              From a simple backyard platform to a multi-level entertainment space,
              we design and build decks that fit your home, lifestyle, and budget.
            </p>
      ...
      <section className="bg-bg-alt py-12 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            ...
            <Link href="/services/deck-cleaning" className="rounded-lg bg-white px-5 py-3 text-sm font-semibold text-wood-dark transition hover:bg-terracotta hover:text-white">Deck Cleaning</Link>
