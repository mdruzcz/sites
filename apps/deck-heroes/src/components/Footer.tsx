      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/stain-choices" className="text-cream-dark hover:text-cream transition-colors">
                  Stain Choices
                </Link>
              </li>
              <li>
                <Link href="/articles" className="text-cream-dark hover:text-cream transition-colors">
                  Articles
                </Link>
              </li>
              <li>
                <Link href="/testimonials" className="text-cream-dark hover:text-cream transition-colors">
                  Testimonials
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-cream-dark hover:text-cream transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-cream-dark hover:text-cream transition-colors">
                  Contact Us
                </Link>
              </li>
            </ul>
        ...
        {/* Bottom bar */}
        <div className="mt-12 border-t border-forest-light/30 pt-8 text-center text-sm text-cream-dark">
          <p>
