      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between h-8 sm:h-9 border-b border-[var(--border)]">
          <p className="text-xs text-[var(--concrete)] uppercase tracking-wider hidden sm:block">
            Brantford · Paris · Cambridge · Hamilton
          </p>
          <a
            href={site.phoneHref}
        ...
        <div className="flex items-center justify-center py-3 sm:py-4 relative">
          <Link href="/" className="flex items-center gap-3 group">
            <Image
              ...
              alt="Total Brantford Concrete logo"
              width={60}
              height={40}
              className="h-10 w-auto"
            />
            <div className="flex flex-col">
              <span className="font-extrabold text-lg sm:text-xl tracking-tight text-[var(--charcoal)] group-hover:text-[var(--accent)] transition-colors leading-none">
                Total Brantford
              </span>
              <span className="font-bold text-[10px] sm:text-xs tracking-[0.2em] uppercase text-[var(--accent)] leading-none">
                Concrete
              </span>
            </div>
          </Link>
