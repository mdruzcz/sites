        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="mb-4 flex items-center gap-3">
              <Image
                src="/images/Total-Brantford-Concrete-Logo.png"
                alt="Total Brantford Concrete"
                width={50}
                height={33}
                className="h-8 w-auto brightness-0 invert"
              />
              <div>
                <p className="font-extrabold text-base tracking-tight leading-none">Total Brantford</p>
                <p className="font-bold text-[10px] tracking-[0.2em] uppercase text-[var(--accent)] mt-0.5">Concrete</p>
              </div>
            </div>
            <p className="text-[var(--concrete-200)] text-sm leading-relaxed mb-4">
              Expert concrete driveways, patios, and repairs across Brantford and Brant County.
              Engineered for Ontario winters with a written warranty on every project.
            </p>
            <p className="text-[var(--concrete-200)] text-xs">
              Also serving: Paris · Cambridge · Hamilton · Caledonia
            </p>
          </div>
