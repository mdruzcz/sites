...
export function OfferPopup() {
  ...
  function copyCode() {
    try {
      navigator.clipboard.writeText("DIY10");
      setCopied(true);
    ...
    >
      ...
      >
        ...
        <div className="relative bg-gradient-to-br from-[var(--color-brand)] via-[var(--color-brand-dark)] to-[var(--color-brand-deep)] px-8 py-10 text-center text-white">
          ...
          <p className="eyebrow relative text-[var(--color-gold)]">⚡ DIY Special</p>
          <h2 id="offer-popup-title" className="font-display relative mt-3 text-4xl font-bold leading-tight">
            Get <span className="text-[var(--color-gold)]">10% OFF</span><br />
            your first DIY kit
          </h2>
          <p className="relative mt-3 text-sm text-purple-100">
            Welcome to Permanent Lighting Direct. Use this code at checkout:
          </p>
        </div>
        ...
        <div className="px-8 py-6 text-center">
          ...
          <p className="mt-4 text-xs text-slate-500">
            Valid on your first DIY kit. One use per customer. Cannot be combined with installer pricing.
          </p>
          <button
            type="button"
            onClick={dismissPopup}
