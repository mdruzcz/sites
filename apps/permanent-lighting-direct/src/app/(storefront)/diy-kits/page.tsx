...
export const metadata = {
  title: "DIY Permanent Lighting Kits — pick your footage",
  description:
    "Complete DIY permanent LED lighting kits — aluminum tracks, RGBW pucks, controller, power supply and connectors. Pick your linear footage from 50ft to 200ft. From $9/ft. Free shipping over $500 in Canada.",
    ...
    <section className="relative overflow-hidden bg-[var(--color-night)] text-white">
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-20 text-center md:py-28">
        ...
        <h1 className="font-display mt-5 text-4xl font-bold leading-[1.05] tracking-tight md:text-6xl">
          ...
          <span className="rainbow-text">Install in a weekend.</span>
        </h1>
        <p className="mx-auto mt-5 max-w-2xl text-lg text-slate-300">
          Discreet aluminum tracks, 24V RGBW LED pucks, WiFi controller, every cable and connector &mdash;
          delivered as a complete DIY kit. Available in 50, 75, 100, 125, 150, 175 and 200 linear-foot sizes.
        </p>
