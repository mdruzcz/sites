  ...
  return (
    <>
      ...
      <PageHero
        ...
        eyebrow="Complete DIY kits"
        title="Six kits. One box each. Everything you need."
        intro="Professional-grade 12V RGBW pucks in aluminum soffit track, a WiFi controller, power supplies, every connector and colour-matched screws. Pick the footage that matches your roofline."
        crumbs={[{ label: "Kits" }]}
      />
