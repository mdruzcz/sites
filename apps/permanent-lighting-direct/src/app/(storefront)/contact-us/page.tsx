...
export const metadata: Metadata = {
  ...
  description: "Ask Permanent Lighting Direct to size a kit from your measurements, check on an order or start a warranty claim. Replies within one business day from London, Ontario.",
  alternates: { canonical: `${SITE_URL}/contact-us` }
};

export default function ContactPage() {
  const jsonLd = { "@context": "https://schema.org", "@type": "ContactPage", name: "Contact Permanent Lighting Direct", url: `${SITE_URL}/contact-us` };
  return (
    <>
        ...
        <div className="shell section grid gap-10 lg:grid-cols-[1.2fr_1fr]">
          ...
          <aside className="space-y-4">
            ...
            <div className="card p-6">
              ...
              <p className="mt-2 text-sm text-[var(--color-text-soft)]">Volume pricing and priority fulfilment for crews and towns.</p>
