...
export const metadata = {
  ...
  description:
    "Don't want to DIY? Find a trusted permanent LED lighting installer in your area. Permanent Lighting Direct partners with installers across Canada."
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <h1 className="font-display mt-2 text-4xl tracking-tight md:text-5xl">
        Rather hire a pro? <span className="rainbow-text">We get it.</span>
      </h1>
      <p className="mt-4 text-lg leading-relaxed text-slate-600">
        Not everyone wants to spend a Saturday on a ladder. Permanent Lighting Direct partners with
        trusted installers across Canada who use our gear &mdash; same pro-grade kit, professional
        installation.
      </p>
      ...
      <div className="mt-10 rounded-2xl border border-[var(--color-border)] bg-white p-6">
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          <a
            href="mailto:service@masterdecker.com?subject=Find%20a%20permanent%20lighting%20installer"
      ...
      <div className="mt-10 rounded-2xl bg-[var(--color-brand-soft)] p-6">
        ...
        <p className="mt-2 text-sm text-slate-700">
          Join the Permanent Lighting Direct installer program for tier pricing, priority shipping, and
          referral leads.
        </p>
