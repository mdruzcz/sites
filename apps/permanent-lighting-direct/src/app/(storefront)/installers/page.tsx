...
export const metadata: Metadata = {
  ...
  description: "Prefer not to climb the ladder? Permanent Lighting Direct connects homeowners across Canada with installers who fit this exact 12V track-and-puck system. Installed pricing from $1,665 for 50 ft.",
      ...
      <section className="bg-[var(--color-bg)]">
        <div className="shell section grid gap-10 lg:grid-cols-[1.2fr_1fr]">
          <div>
            ...
            <p className="mt-4 text-[var(--color-text-soft)]">We reply within one business day with an installer in your area, or an installed quote from our own crew if you are in Southwestern Ontario.</p>
            <div className="mt-8">
