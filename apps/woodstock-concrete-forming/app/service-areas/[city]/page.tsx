...
export async function generateMetadata({
  ...
  if (!city) return {};
  return {
    title: `Concrete Driveways & Patios in ${city.name}, ON`,
    description: `Expert concrete driveways and patios in ${city.name}, Ontario. Natural broom finish and stamped concrete by ${site.name} — free on-site quote, written warranty.`,
    openGraph: {
      title: `Concrete Contractor in ${city.name} | ${site.name}`,
      description: `Concrete driveways and patios in ${city.name}, ON. Free quote, written warranty.`,
    },
  };
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="h-display text-4xl sm:text-5xl mb-4">
              Concrete Driveways & Patios in {city.name}, Ontario
            </h1>
