...
export const metadata: Metadata = {
  title: "Service Areas",
  description: `${site.name} serves Woodstock, Brantford, Cambridge, and surrounding Oxford and Brant County communities with concrete driveways and patios.`,
  openGraph: {
    title: `Service Areas | ${site.name}`,
    description: "Concrete driveways and patios in Woodstock, Brantford, Cambridge, and Oxford County.",
  },
};
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-[var(--concrete)] max-w-2xl mx-auto normal-case font-normal">
              Serving Oxford County, Brant County, and Waterloo Region with expert concrete driveways and patios. Local crews, no travel surcharges.
            </p>
          </div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mt-auto">
                  {services.map((s) => (
                    ...
                    >
                      {s.slug === "concrete-driveways" ? "Driveways" : "Patios"}
                    </span>
                  ))}
                </div>
              </Link>
          ...
          <div className="card p-6 text-center">
            <p className="text-sm text-[var(--concrete)] normal-case">
              Also serving: <strong>Ingersoll</strong> · <strong>Paris</strong> · <strong>Tillsonburg</strong> · <strong>Simcoe</strong> · <strong>Kitchener</strong> · <strong>Guelph</strong> and surrounding communities.
