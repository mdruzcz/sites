...
export async function generateMetadata({
  ...
  return {
    ...
    description: `${service.shortDescription} Serving Woodstock, Brantford, Cambridge, and Oxford County. Free on-site quote from ${site.name}.`,
    openGraph: {
      ...
      <section className="py-12 sm:py-16 bg-[var(--charcoal)] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="eyebrow !text-[var(--accent)]">Woodstock · Brantford · Cambridge</p>
