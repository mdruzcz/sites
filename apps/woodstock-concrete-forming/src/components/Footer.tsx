        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="mb-4">
              ...
              <p className="font-bold text-xs tracking-[0.3em] uppercase text-[var(--accent)] mt-0.5">Concrete Forming</p>
            </div>
            <p className="text-[var(--concrete-200)] text-sm leading-relaxed mb-4">
              Expert concrete driveways and patios in Woodstock, Brantford, and Cambridge.
              Engineered for Ontario winters with a written warranty on every project.
            </p>
            <p className="text-[var(--concrete-200)] text-xs">
              Also serving: Ingersoll · Paris · Tillsonburg · Simcoe · Brantford County
            </p>
          </div>
