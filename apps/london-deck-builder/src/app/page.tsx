    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt="Beautiful deck in London Ontario"
          fill
...
function ServiceAreas() {
  const areas = [
    {
      city: "London",
      desc: "London Deck Builders offers unbeatable decking solutions in London, Ontario, expertly serving popular areas like Byron and Old North.",
      highlights: ["Byron", "Old North", "Westmount", "Masonville"],
    },
    {
      city: "St. Thomas",
      desc: "Delivering top-notch decking services in St. Thomas, Ontario, skillfully serving key places like Lake Margaret and Courtright.",
      highlights: ["Lake Margaret", "Courtright", "Mitchell Hepburn", "Fingal Line"],
    },
    {
      city: "Woodstock",
      desc: "Providing top-tier decking excellence in Woodstock, Ontario, proudly serving well-known areas like Fairview and Vansittart.",
      highlights: ["Fairview", "Vansittart", "Beachville", "Sweaburg"],
    },
  ];
    ...
    <section className="py-20 lg:py-28" style={{ backgroundColor: "var(--wood-dark)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-white/60">
            Whether you're right in the city or a bit outside, we're ready to build your perfect deck.
          </p>
        </div>

        <div className="grid md:grid-cols-3 gap-6">
          {areas.map((a) => (
            <div key={a.city} className="rounded-2xl p-8 border" style={{ backgroundColor: "rgba(255,255,255,0.05)", borderColor: "rgba(255,255,255,0.08)" }}>
              <div className="flex items-center gap-2 mb-3" style={{ color: "var(--sand)" }}>
                <MapPinIcon />
                <h3 className="font-serif text-2xl font-bold">{a.city}</h3>
              </div>
              <p className="text-sm leading-relaxed mb-4 text-white/60">{a.desc}</p>
              <div className="flex flex-wrap gap-2">
                {a.highlights.map((h) => (
                  <span key={h} className="text-xs px-3 py-1 rounded-full" style={{ backgroundColor: "rgba(196,98,58,0.2)", color: "var(--sand-light)" }}>
                    {h}
                  </span>
                ))}
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="space-y-5">
              ...
              <a href="mailto:sales@londondeckbuilder.ca" className="flex items-center gap-4 group">
                <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{ backgroundColor: "var(--terracotta)", color: "white" }}>
                  <MailIcon />
                </div>
                <div>
                  <p className="text-xs uppercase tracking-wider mb-0.5" style={{ color: "var(--wood-light)" }}>Email</p>
                  <p className="font-semibold group-hover:underline" style={{ color: "var(--wood-dark)" }}>sales@londondeckbuilder.ca</p>
                </div>
              </a>
    ...
    <footer style={{ backgroundColor: "#1C0E08", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2 text-sm text-white/50">
                <MailIcon />
                <a href="mailto:sales@londondeckbuilder.ca" className="hover:text-white/80 transition break-all">sales@londondeckbuilder.ca</a>
              </li>
              <li className="flex items-start gap-2 text-sm text-white/50">
                <MapPinIcon />
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-white/20">Serving London, St. Thomas & Woodstock, Ontario</p>
        </div>
      </div>
    </footer>
  );
