      ...
      <div className="container py-16 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/80">
            <li>
              <a href={site.phoneHref} className="hover:text-[var(--accent-light)] transition-colors">Phone: {site.phone}</a>
            </li>
            <li>
              <a href={`mailto:${site.email}`} className="hover:text-[var(--accent-light)] transition-colors">Email: {site.email}</a>
            </li>
        ...
        <div>
          <div className="text-sm font-bold uppercase tracking-widest mb-5 text-[var(--accent-light)]">Quick Links</div>
          <ul className="space-y-2.5">
            {quickLinks.map((l) => (
              <li key={l.href}>
                <Link href={l.href} className="text-sm text-white/80 hover:text-[var(--accent-light)] transition-colors">{l.label}</Link>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          <div className="text-sm font-bold uppercase tracking-widest mb-5 text-[var(--accent-light)]">Additional Resources</div>
          <ul className="space-y-2.5">
        ...
        <div>
          <div className="text-sm font-bold uppercase tracking-widest mb-5 text-[var(--accent-light)]">Follow Us</div>
          ...
          <div className="text-sm font-bold uppercase tracking-widest mb-3 text-[var(--accent-light)]">Join Our Newsletter</div>
