...
export const metadata: Metadata = {
  ...
  description: "Illumi Track Lights ships from London, Ontario within two business days. Free shipping across Canada on orders over $500, 30-day returns on unused items.",
