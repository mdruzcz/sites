...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <PageHero photo="install-track-mounting" eyebrow="Contact" title="Send us the house. We'll size the kit or book the crew." intro="Measurements, a photo, your soffit colour and postal code are all we need to recommend a size and quote shipping." crumbs={[{ label: "Contact" }]} compact />
