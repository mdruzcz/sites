...
export const metadata: Metadata = {
  ...
  description: "Every Illumi Track Lights kit and component carries a five-year parts warranty against manufacturing defects. What is covered, what is not, and how to make a claim.",
