...
export const metadata = {
  title: "5-Year Warranty on LED Soffit Track Systems",
  description:
    "Every soffit track system we sell carries a five-year warranty against manufacturing defects. See what is covered, what is not, and how to start a claim.",
  alternates: { canonical: `${SITE_URL}/warranty` },
  openGraph: {
    title: "5-Year Warranty on LED Soffit Track Systems",
    description: "Five years of coverage against manufacturing defects on every LED soffit system.",
...
export default function WarrantyPage() {
  return (
    <>
      <PageHero
        photo="home-roofline-garage"
        photoAlt="Home lit with warm permanent LED soffit track lighting along the roofline and garage"
        eyebrow="Coverage"
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              <div className="card p-8">
                ...
                <ul className="mt-5 space-y-3 text-sm leading-relaxed text-[var(--color-text-soft)]">
                  <li>RGBW pucks, aluminum track and housings that fail from a manufacturing defect</li>
