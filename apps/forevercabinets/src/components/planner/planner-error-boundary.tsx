  ...
  render() {
    ...
    return (
      <div role="alert" className="mx-auto max-w-xl px-4 py-12">
        <p className="text-[11px] uppercase tracking-[0.3em] text-[var(--color-brass-dark)]">Kitchen planner</p>
        <h1 className="mt-1 font-display text-3xl text-[var(--color-navy)]">Something went wrong</h1>
        ...
        <details className="mt-6 rounded-sm border border-[var(--color-line)] bg-white p-3 text-[11px] text-[var(--color-ink-soft)]">
          <summary className="cursor-pointer text-[var(--color-navy)]">Technical details</summary>
