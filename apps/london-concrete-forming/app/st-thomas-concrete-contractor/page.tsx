...
export const metadata: Metadata = {
  title: "Concrete Contractor in St. Thomas, ON — Driveways & Patios",
  description: "Expert concrete contractor serving St. Thomas, Ontario. Driveways, patios, stamped concrete, retaining walls & more. 20+ years experience. Free quotes — 519-914-1901.",
  openGraph: {
    ...
    images: [{ url: "https://londonconcreteforming.ca/wp-content/uploads/2025/09/Concrete-Contractor-in-St.-Thomas.png", alt: "Concrete contractor services in St. Thomas, Ontario" }],
  },
};
...
const faqItems = [
  { question: "Do you serve St. Thomas, Ontario?", answer: "Yes — St. Thomas is one of our primary service areas. London Concrete Forming serves St. Thomas and Elgin County regularly with no additional travel fees." },
...
export default function StThomasPage() {
  const jsonLd = [
    serviceSchema({ name: "Concrete Contractor in St. Thomas, ON", description: "Professional concrete services in St. Thomas, Ontario — driveways, patios, retaining walls, and more.", url: site.url + "/st-thomas-concrete-contractor", city: "St. Thomas" }),
    ...
    <>
      ...
      <section className="bg-[#333333] relative overflow-hidden py-24">
        <div className="absolute inset-0">
          <Image src="https://londonconcreteforming.ca/wp-content/uploads/2025/09/Concrete-Contractor-in-St.-Thomas.png" alt="Concrete contractor working in St. Thomas, Ontario" fill className="object-cover opacity-25" priority unoptimized />
        </div>
        <div className="relative container-custom max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-xl mb-8">Driveways, patios, retaining walls &amp; stamped concrete — 20+ years of experience serving St. Thomas and Elgin County.</p>
      ...
      <section className="section bg-white">
        <div className="container-custom">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-600 max-w-xl mx-auto">The same full menu of concrete services available in London — now fully serviced in St. Thomas and Elgin County.</p>
          </div>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { title: "No Travel Fees", desc: "St. Thomas is part of our regular service area. You receive the same pricing as our London customers — no surcharges." },
                  ...
                  { title: "Insured & Reliable", desc: "Fully insured for residential concrete work. We provide start dates and stick to them — no ghost contractors." },
                ].map((item) => (
            ...
            <div className="relative h-80 rounded-2xl overflow-hidden shadow-lg">
              <Image src="https://londonconcreteforming.ca/wp-content/uploads/2025/09/Concrete-Contractor-in-St.-Thomas.png" alt="Concrete work completed by London Concrete Forming in St. Thomas, Ontario" fill className="object-cover" unoptimized />
            </div>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="bg-[#f8fafc] rounded-xl p-5">
                <ul className="space-y-2 text-sm text-slate-600">
                  {["Free on-site estimate within 2–5 business days", "Detailed written quote with itemized breakdown", "No travel fees for St. Thomas projects", "No obligation after the estimate"].map((i) => (
