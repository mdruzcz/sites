...
export const metadata: Metadata = {
  alternates: { canonical: "https://londonconcreteforming.ca/st-thomas-concrete-contractor" },
  title: "Concrete Contractor in St. Thomas, ON | Elgin County",
  description: "Driveways, patios and retaining walls for St. Thomas and Elgin County homes, including heritage brick properties. Free estimates, quotes within 1 business day.",
  openGraph: {
    title: "Concrete Contractor in St. Thomas, ON | Elgin County",
    description: "Driveways, patios and retaining walls for St. Thomas and Elgin County homes, including heritage brick properties. Free estimates, quotes within 1 business day.",
...
export default function StThomasPage() {
  ...
  return (
    <>
      ...
      {/* Form */}
      <Expansion slug="st-thomas-concrete-contractor" />
      <section className="section bg-white">
        <div className="container-custom">
