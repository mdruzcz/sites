...
export default function Page() {
  const jsonLd = [
    serviceSchema({ name: "Concrete Stamps", description: "See our collection of concrete stamping patterns available for driveways and patios in London, Ontario.", url: site.url + "/concrete-stamps" }),
    ...
    <>
      ...
      <section className="bg-[#1a2332] py-20">
        <div className="container-custom text-center max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Concrete Stamps</h1>
      ...
      <section className="section bg-white">
        <div className="container-custom max-w-3xl mx-auto">
          <p className="text-slate-600 leading-relaxed text-lg mb-6">See our collection of concrete stamping patterns available for driveways and patios in London, Ontario.</p>
