  ...
  return (
    <section className="section bg-white">
      <div className="container-custom max-w-3xl mx-auto prose prose-slate">
        <h1 className="text-3xl font-extrabold text-[#333333] mb-6">Privacy Policy</h1>
        <p className="text-slate-500 text-sm mb-8">Last updated: January 1, 2025</p>

        <h2 className="text-xl font-bold text-[#333333] mt-8 mb-3">Information We Collect</h2>
        ...
        <h2 className="text-xl font-bold text-[#333333] mt-8 mb-3">How We Use Your Information</h2>
        ...
        <h2 className="text-xl font-bold text-[#333333] mt-8 mb-3">Data Security</h2>
        ...
        <h2 className="text-xl font-bold text-[#333333] mt-8 mb-3">Cookies</h2>
        ...
        <h2 className="text-xl font-bold text-[#333333] mt-8 mb-3">Contact Us</h2>
