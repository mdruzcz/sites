...
export const metadata: Metadata = {
  alternates: { canonical: "https://londonconcreteforming.ca/port-stanley-concrete-contractor" },
  title: "Concrete Contractor in Port Stanley, ON | Lake Erie",
  description: "Concrete driveways and patios built for Port Stanley cottages and lakeside homes near Kettle Creek. Seasonal scheduling available. Free estimates, 519-914-1901.",
  openGraph: {
    title: "Concrete Contractor in Port Stanley, ON | Lake Erie",
    description: "Concrete driveways and patios built for Port Stanley cottages and lakeside homes near Kettle Creek. Seasonal scheduling available. Free estimates, 519-914-1901.",
  },
...
export default function PortStanleyPage() {
  ...
  return (
    <>
      ...
      {/* Form */}
      <Expansion slug="port-stanley-concrete-contractor" />
      <section className="section bg-[#f8fafc]">
        <div className="container-custom">
