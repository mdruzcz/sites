...
export const metadata: Metadata = {
  title: "Advantages of a Concrete Driveway | London Concrete Forming",
    ...
    <>
      ...
      <article className="section bg-white">
        <div className="container-custom max-w-3xl mx-auto">
          ...
          <h2 className="text-2xl font-extrabold text-[#1a2332] mt-8 mb-4">1. Exceptional Durability</h2>
          ...
          <h2 className="text-2xl font-extrabold text-[#1a2332] mt-8 mb-4">2. Low Maintenance</h2>
          ...
          <h2 className="text-2xl font-extrabold text-[#1a2332] mt-8 mb-4">3. Better Curb Appeal</h2>
          ...
          <h2 className="text-2xl font-extrabold text-[#1a2332] mt-8 mb-4">4. Handles Ontario Winters</h2>
          ...
          <h2 className="text-2xl font-extrabold text-[#1a2332] mt-8 mb-4">5. Better Return on Investment</h2>
