...
export const metadata: Metadata = {
  title: "Concrete Contractor in Chatham, ON â€” Driveways & Patios",
  description: "Expert concrete contractor serving Chatham-Kent, Ontario. Driveways, patios, stamped concrete, retaining walls & more. 20+ years experience. Free quotes â€” 519-914-1901.",
  openGraph: {
    title: "Concrete Contractor in Chatham, ON",
    description: "Professional concrete services in Chatham, Ontario. Driveways, patios, retaining walls & stamped concrete from London Concrete Forming.",
  },
};
...
const faqItems = [
  { question: "Do you serve Chatham, Ontario?", answer: "Yes â€” London Concrete Forming serves Chatham-Kent homeowners with the full range of concrete services. Chatham is within our regular service territory." },
  ...
  { question: "Are there travel fees for Chatham projects?", answer: "For most projects in Chatham proper, we do not charge travel fees. For projects in more remote Chatham-Kent areas, we may add a small travel supplement â€” we will disclose this clearly in your written quote." },
...
export default function ChathamPage() {
  const jsonLd = [
    serviceSchema({ name: "Concrete Contractor in Chatham, ON", description: "Professional concrete services in Chatham, Ontario â€” driveways, patios, retaining walls, and more.", url: site.url + "/chatham-concrete-contractor", city: "Chatham" }),
    ...
    <>
      ...
      <section className="bg-[#333333] relative overflow-hidden py-24">
        ...
        <div className="relative container-custom max-w-4xl mx-auto text-center">
          ...
          <p className="text-slate-300 text-xl mb-8">Driveways, patios, retaining walls &amp; stamped concrete â€” 20+ years of experience serving Chatham and Chatham-Kent.</p>
      ...
      <section className="section bg-white">
        <div className="container-custom">
          <div className="text-center mb-10">
            ...
            <p className="text-slate-600 max-w-xl mx-auto">Everything from new driveway installation to stamped concrete patios â€” fully serviced in Chatham-Kent.</p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { title: "Quality Materials", desc: "We use only 32 MPa concrete â€” the minimum grade required for residential driveways in Ontario. No watered-down mixes." },
            ...
            <div>
              ...
              <div className="bg-[#f8fafc] rounded-xl p-5">
                <ul className="space-y-2 text-sm text-slate-600">
                  {["Free on-site estimate within 2â€“5 business days", "Detailed written quote with itemized breakdown", "Transparent pricing â€” no hidden fees", "No obligation after the estimate"].map((i) => (
