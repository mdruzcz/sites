...
export const metadata: Metadata = {
  alternates: { canonical: "https://londonconcreteforming.ca" },
  title: { absolute: "Concrete Contractor London Ontario | London Concrete Forming" },
  description: "London Concrete Forming is a concrete contractor serving London, Ontario with driveways, patios, retaining walls & stamped concrete. Free quotes today.",
  openGraph: {
    title: "Concrete Contractor London Ontario | Driveways & Patios",
    description: "London Concrete Forming is a concrete contractor serving London, Ontario with driveways, patios, retaining walls & stamped concrete. Free quotes today.",
    url: site.url,
  ...
  twitter: { card: "summary_large_image", title: "Concrete Contractor London Ontario | London Concrete Forming" },
};
        ...
        <div className="relative container-custom py-16 md:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight mb-5">Concrete Contractor in London, Ontario</h1>
