...
export const metadata: Metadata = {
  title: "Concrete Finishes — Broom, Exposed Aggregate, Stamped & More",
  description: "Explore every concrete finish in London, Ontario — broom, exposed aggregate, polished, coloured & stamped. Expert installation by LCF. Free quotes.",
  openGraph: {
    title: "Concrete Finishes — Broom, Exposed Aggregate, Stamped & More",
    description: "See all concrete finish options from London Concrete Forming — the region's most trusted concrete contractor.",
    images: [{ url: "https://londonconcreteforming.ca/wp-content/uploads/2025/02/drive.jpg", alt: "Concrete finishes by London Concrete Forming" }],
  },
};
            ...
            {finishes.map((finish, i) => (
              <div key={finish.name} className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                ...
                <div className={`relative h-72 rounded-2xl overflow-hidden shadow-lg ${i % 2 === 1 ? "lg:order-1" : ""}`}>
                  <Image src={finish.image} alt={finish.imageAlt} fill className="object-cover" unoptimized />
                </div>
              </div>
            ))}
          </div>
