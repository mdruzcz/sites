...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <section className="bg-[#1a2332] py-16 md:py-24">
      ...
      <section className="section bg-white">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-extrabold text-[#1a2332] mb-5">Our Customer-Centric Approach</h2>
      ...
      <section className="section bg-[#f8fafc]">
        <div className="container-custom max-w-4xl mx-auto">
          <h2 className="text-3xl font-extrabold text-[#1a2332] mb-5 text-center">Quality You Can Count On</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card p-6">
              <h3 className="font-bold text-[#1a2332] text-lg mb-3">Experienced Team</h3>
            ...
            <div className="card p-6">
              <h3 className="font-bold text-[#1a2332] text-lg mb-3">Quality Materials</h3>
            ...
            <div className="card p-6">
              <h3 className="font-bold text-[#1a2332] text-lg mb-3">Fair Pricing</h3>
            ...
            <div className="card p-6">
              <h3 className="font-bold text-[#1a2332] text-lg mb-3">Local & Trusted</h3>
      ...
      <section className="section bg-white">
        <div className="container-custom max-w-2xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-extrabold text-[#1a2332] mb-3">Ready to Get Started?</h2>
