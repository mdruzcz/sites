...
export const metadata: Metadata = {
  alternates: { canonical: "https://londonconcreteforming.ca/concrete-driveways-woodstock" },
  title: "Concrete Driveways Woodstock ON | Rural & Subdivision",
  description: "Concrete driveway installation in Woodstock, Ontario for long rural lanes and new subdivision lots. Free on-site estimates from London Concrete Forming, 519-914-1901.",
  openGraph: { title: "Concrete Driveways Woodstock ON | Rural & Subdivision", description: "Concrete driveway installation in Woodstock, Ontario for long rural lanes and new subdivision lots. Free on-site estimates from London Concrete Forming, 519-914-1901." },
};
    ...
    <>
      ...
      <section className="bg-[#333333] py-20">
        <div className="container-custom text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Concrete Driveways in Woodstock, Ontario: Farm Lanes to New Subdivisions</h1>
      ...
      <Expansion slug="concrete-driveways-woodstock" />
