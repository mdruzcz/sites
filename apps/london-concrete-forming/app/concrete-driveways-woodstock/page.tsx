...
export const metadata: Metadata = {
  title: "Concrete Driveways in Woodstock, ON | London Concrete Forming",
  ...
  openGraph: { title: "Concrete Driveways in Woodstock, ON | London Concrete Forming", description: "Expert concrete driveway installation in Woodstock, Ontario." },
};
      ...
      <section className="section bg-white">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-extrabold text-[#1a2332] mb-5">Expert Concrete Driveway Installation in Woodstock</h2>
