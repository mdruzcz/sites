...
export const metadata: Metadata = {
  ...
  description: "Transform your home with a stamped concrete driveway in London, Ontario. Cobblestone, slate, brick & more. 20+ years experience. Free quotes — 519-914-1901.",
  openGraph: {
    title: "Stamped Concrete Driveway Installation in London, Ontario",
    description: "Beautiful stamped concrete driveways in London, Ontario. 50+ patterns, custom colours. London Concrete Forming — 20+ years experience.",
    images: [{ url: "https://londonconcreteforming.ca/wp-content/uploads/2025/02/drive.jpg", alt: "Stamped concrete driveway installation in London, Ontario" }],
  },
};
      ...
      <section className="bg-[#333333] relative overflow-hidden py-20">
        <div className="absolute inset-0">
          <Image
            ...
            fill className="object-cover opacity-30" priority unoptimized
          />
        </div>
