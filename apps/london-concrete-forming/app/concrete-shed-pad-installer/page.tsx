...
export const metadata: Metadata = {
  alternates: { canonical: "https://londonconcreteforming.ca/concrete-shed-pad-installer" },
  title: "Concrete Shed & Garage Pads London Ontario | Sizing Guide",
  description: "Concrete shed, garage, and hot tub pads in London, Ontario built to the right thickness and grading for the load. Free quotes, 519-914-1901.",
  openGraph: {
    title: "Concrete Shed & Garage Pads London Ontario | Sizing Guide",
    description: "Concrete shed, garage, and hot tub pads in London, Ontario built to the right thickness and grading for the load. Free quotes, 519-914-1901.",
...
export default function ConcreteShedPadPage() {
  ...
  return (
    <>
      ...
      {/* Form */}
      <Expansion slug="concrete-shed-pad-installer" />
      <section className="section bg-[#f8fafc]">
