...
// Self-contained: inline styles only, no external CSS or dependencies, so it
// renders identically regardless of the host site's Tailwind config.
export function AwardBadge({ style }: { style?: CSSProperties }) {
  const AWARD_URL = "https://serviceexcellenceawards.ca/winners/london/foundation-waterproofing/london-concrete-forming-2026";
  const CATEGORY = "Foundation & Forming";
  const CITY = "London";
  return (
    <a
      href={AWARD_URL}
