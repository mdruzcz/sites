      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Professional concrete contractors serving Woodstock and Oxford County.
              {site.yearsExperience}+ years of experience building driveways, patios,
              and more that last through harsh winters.
            </p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10">
          <p className="text-center text-slate-500 text-sm">
            &copy; {new Date().getFullYear()} {site.name}. All rights reserved. Serving Woodstock, Ontario and surrounding areas.
          </p>
        </div>
      </div>
    </footer>
