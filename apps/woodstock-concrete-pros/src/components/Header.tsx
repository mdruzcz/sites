...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 bg-[var(--charcoal)] border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          <Link href="/" className="flex items-center gap-2">
            ...
            <div>
              <span className="font-extrabold text-white text-lg leading-tight">WOODSTOCK</span>
              <span className="block text-[var(--accent)] text-xs font-bold tracking-widest -mt-0.5">CONCRETE PROS</span>
            </div>
          </Link>
