...
export const metadata: Metadata = {
  ...
  description: `Get a free concrete quote from ${site.name}. Call ${site.phone} or fill out our form. Serving Woodstock, Ingersoll, Tillsonburg, Norwich, and Oxford County.`,
};
      ...
      <section className="bg-[var(--charcoal)] py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-slate-300 max-w-3xl">
            Ready for stronger, better-looking concrete? Get a free on-site consultation
