...
export const metadata: Metadata = {
  ...
  description: "Terms of service for Restore My Deck.",
};
...
export default function TermsPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-3xl prose prose-gray">
      ...
      <p>{site.name} is not liable for pre-existing damage, wood that is beyond restoration, or delays due to weather conditions outside our control.</p>
      <h2>Contact</h2>
