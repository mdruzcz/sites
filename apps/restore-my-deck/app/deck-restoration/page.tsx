    ...
    <>
      ...
      <div className="bg-[var(--dark)] py-16 px-4 text-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold font-[var(--font-montserrat)]">Deck Restoration</h1>
          <p className="mt-4 text-gray-400 text-lg max-w-2xl">Complete 4-step restoration that brings weathered decks back to life — without replacement. Serving Kitchener-Waterloo, Guelph, Cambridge, Hamilton and area.</p>
