    ...
    <>
      ...
      <div className="bg-[var(--dark)] py-16 px-4 text-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold font-[var(--font-montserrat)]">Deck Staining</h1>
          <p className="mt-4 text-gray-400 text-lg max-w-2xl">Brush-applied premium oil-based staining for decks in Kitchener-Waterloo and surrounding areas. Products that fade gracefully and never peel.</p>
