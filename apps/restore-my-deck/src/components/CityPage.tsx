    ...
    <>
      ...
      <div className="bg-[var(--dark)] py-16 px-4 text-white">
        <div className="container mx-auto max-w-4xl">
          <p className="text-[var(--accent)] font-semibold text-sm uppercase tracking-widest mb-2">{city}, {region}</p>
          <h1 className="text-4xl md:text-5xl font-extrabold font-[var(--font-montserrat)]">Professional Deck &amp; Fence Staining in {city}, {region}</h1>
          <p className="mt-4 text-gray-400 text-lg max-w-2xl">{intro}</p>
