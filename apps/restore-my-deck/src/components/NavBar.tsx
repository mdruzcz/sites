...
const navLinks = [
  ...
  { label: "Restoration", href: "/deck-restoration" },
  { label: "Fences", href: "/fence-staining" },
...
const mobileExtra = [
  { label: "Deck Cleaning & Power Washing", href: "/pressure-washing-services" },
  { label: "Deck Sealing & Sanding", href: "/sealing-services" },
  { label: "Deck Repair & Rebuilding", href: "/deck-repair-and-maintenance" },
...
export function NavBar() {
  ...
  return (
    <header className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${scrolled || open ? "bg-[rgba(251,248,243,0.96)] shadow-[0_1px_0_var(--line),0_10px_30px_-18px_rgba(33,26,20,0.35)]" : "bg-[rgba(251,248,243,0.88)]"}`}>
      <nav className="shell">
        <div className="flex h-[76px] items-center justify-between gap-4">
          <Link href="/" className="flex-shrink-0" aria-label="Restore My Deck home">
            <Image src="/images/logo.png" alt="Restore My Deck" width={522} height={223} priority className="h-11 w-auto md:h-12" />
          </Link>
      ...
      {mounted && open && createPortal(
        <div className="fixed inset-x-0 bottom-0 top-[76px] z-40 overflow-y-auto bg-[var(--paper)] lg:hidden">
