...
export const metadata: Metadata = {
  title: "Contact Us",
  description: `Get a free concrete sealing quote from ${site.name}. Call ${site.phone} or fill out our form. Serving ${site.serviceAreas.join(", ")}.`,
};
      ...
      <section className="bg-navy py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-slate-300 max-w-3xl">
            Ready to protect your concrete? Get a free quote and inspection — most quotes
            ...
            <div>
              ...
              <div className="mt-8 p-6 bg-[var(--surface)] rounded-xl">
                ...
                <ol className="space-y-2 text-sm text-slate-600">
                  ...
                  <li className="flex gap-2"><span className="font-bold text-[var(--accent)]">3.</span> Free on-site inspection and assessment</li>
