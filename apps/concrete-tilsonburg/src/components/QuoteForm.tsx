...
export function QuoteForm({ defaultService, variant = "card" }: Props) {
  ...
  if (status === "sent") {
    return (
      ...
      >
        ...
        <h3 className="text-xl font-bold text-[var(--charcoal)] mb-2">Estimate Request Sent!</h3>
  ...
  return (
    ...
    >
      <div>
        <h3 className="text-xl font-bold mb-1 text-[var(--charcoal)]">Get a Free Estimate</h3>
