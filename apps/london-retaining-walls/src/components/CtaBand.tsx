...
export default function CtaBand({ title = "Ready to Build Your Retaining Wall?" }: { title?: string }) {
  return (
    <section className="bg-[var(--accent)] py-14 px-4">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
        <div>
          ...
          <p className="mt-2 text-white/90 text-lg">Free quotes. Ontario Building Code compliant. Serving all of Southwestern Ontario.</p>
        </div>
