...
const projectPhotos = gallery.filter((p) => p.material === "timber").slice(0, 3);
      ...
      <section className="section bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] uppercase tracking-wide text-center mb-3 font-[family-name:var(--font-poppins)]">
            Recent Wood &amp; Timber Retaining Wall Projects
          </h2>
          <p className="text-center text-gray-500 mb-10 max-w-2xl mx-auto">
            A few of the wood and timber retaining walls we&apos;ve built across London and Southwestern Ontario.
          </p>
