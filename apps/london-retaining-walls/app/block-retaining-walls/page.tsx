...
const projectPhotos = gallery.filter((p) => p.material === "segmental-block").slice(0, 3);
        ...
        <div className="container mx-auto px-4 grid lg:grid-cols-3 gap-10">
          <div className="lg:col-span-2 space-y-8">
            <div className="relative rounded-xl overflow-hidden h-72 w-full">
              <Image src="/images/long-lasting-walls.png" alt="Block retaining wall installation — interlocking concrete blocks in London, Ontario" fill className="object-cover" sizes="(max-width:1024px) 100vw, 66vw" />
            </div>
            <div>
      ...
      <section className="section bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl md:text-3xl font-extrabold text-[var(--dark)] uppercase tracking-wide text-center mb-3 font-[family-name:var(--font-poppins)]">
            Recent Block Retaining Wall Projects
          </h2>
          <p className="text-center text-gray-500 mb-10 max-w-2xl mx-auto">
            A few of the interlocking segmental block retaining walls we&apos;ve built across London and Southwestern Ontario.
          </p>
