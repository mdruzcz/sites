...
export async function generateMetadata({
  ...
  const description = `${service.shortDescription} Serving London, Ontario and surrounding areas. Call ${site.phone} for a free consultation.`;
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mt-12">
                ...
                <p className="text-slate-600 mb-4">
                  We provide {service.title.toLowerCase()} services across London and Southwestern Ontario:
                </p>
