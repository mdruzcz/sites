...
export async function generateMetadata({
  ...
  const description = `Professional ${service.title.toLowerCase()} in ${city.name}, Ontario. ${service.shortDescription} Call ${site.phone} for a free consultation.`;
      ...
      <section className="bg-navy py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-slate-300 max-w-3xl">
            ...
            Fully permitted, code-compliant work from {site.name}.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <div className="mt-8 p-6 bg-[var(--surface)] rounded-xl">
                <h3 className="font-bold text-lg mb-2">Ready to get started in {city.name}?</h3>
                <p className="text-slate-600 mb-4">
                  Call us today for a free consultation on {service.title.toLowerCase()} in {city.name}.
                </p>
