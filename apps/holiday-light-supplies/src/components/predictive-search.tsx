      ...
      >
        <div className="flex items-center gap-3 border-b border-[var(--color-border)] px-4 py-3">
          ...
          <input
            ...
            placeholder="Search bulbs, globes, strands, trees, displays…"
          ...
          {!q && (
            <div className="px-4 py-6 text-sm">
              ...
              <ul className="mt-2 flex flex-wrap gap-2">
                {["C9 bulbs", "G20 globe lights", "Mini lights", "Snowfall lights", "LED tree", "3D display"].map((s) => (
                  <li key={s}>
                    <button
                      type="button"
                      onClick={() => setQ(s)}
          ...
          {!loading && q.length >= 2 && hits.length === 0 && (
            <div className="px-4 py-6 text-sm">
              ...
              <p className="text-slate-500">
                Try a broader term — like <em>bulb</em>, <em>globe</em>, or <em>tree</em>.
              </p>
            </div>
          )}
