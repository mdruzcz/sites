...
const COLUMNS: MenuColumn[] = [
  {
    ...
    href: "/product-category/permanent-lighting-kits",
    emoji: "★",
    links: [
      { label: "Permanent LED kits (50–250 ft)", href: "/product-category/permanent-lighting-kits" },
      { label: "How the kits work", href: "/product/permanent-lighting-kit-100ft" },
      { label: "Pro installer pricing", href: "/professional-installer" }
    ]
  },
  {
    title: "String Lights",
  ...
  return (
    ...
    >
      ...
      {open && (
        <div
          role="menu"
          className="absolute inset-x-0 top-full z-40 mt-3 rounded-2xl border border-[var(--color-border)] bg-white p-6 shadow-xl"
        >
