...
export const metadata = {
  ...
  description:
    "Browse every C9 strawberry bulb, G20 globe, 5mm mini strand, snowfall tube, LED tree and 3D display. Bulk-priced for installers. Shipped from our Ontario warehouse."
};
