...
export default function ShippingReturnsPage() {
  return (
    <article className="mx-auto max-w-3xl px-4 py-12 prose prose-slate">
      ...
      <h2>Free shipping</h2>
      <p>Enjoy free shipping on all orders over <strong>$150 CAD</strong> shipped across Ontario.</p>
      <h2>Returns policy</h2>
      <p>Products can be returned for a <strong>full refund</strong>, provided all items are in their original packaging and no components are missing.</p>
