...
const FEATURES = [
  ...
  "Black, white, wicker or brown tracks",
        ...
        <div className="grid gap-14 lg:grid-cols-2 lg:items-center lg:gap-20">
          <div className="reveal">
            ...
            <p className="mt-6 max-w-xl lead text-[var(--color-text-soft)]">
              Soffit-matched aluminum tracks holding 12V RGBW LED pucks. Pick your house perimeter, pick your
              track colour, and we ship the whole system to your door — lights, tracks, controller, power
              supplies, connectors and colour-matched screws.
            </p>
