...
export const metadata = {
  title: "Permanent LED & Christmas Lighting FAQ",
  description:
    "Answers on C7 vs C9 bulbs, LED lifespan, weather resistance, installation and Canadian shipping for permanent and Christmas lighting.",
