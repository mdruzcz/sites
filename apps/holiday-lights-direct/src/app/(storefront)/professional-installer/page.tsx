...
export const metadata = {
  title: "Installer Program: Bulk LED Pricing",
  description:
    "Bulk pricing, free shipping and priority peak-season stock for Christmas light installers and landscapers across Canada.",
