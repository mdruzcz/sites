...
export const metadata = {
  title: "Municipal & BIA Lighting Supplier",
  description:
    "Net-30 PO invoicing, tax-exempt pricing and RFP-ready quotes on permanent LED lighting for Ontario municipalities, BIAs and parks.",
