...
const SECTIONS = [
  ...
  },
  {
    ...
    body: "Products can be returned for a full refund provided all items are in their original packaging and no components are missing from LED housing packages."
  },
  {
...
export default function ShippingReturnsPage() {
  return (
    <>
      <PageHero
        photo="home-side-elevation"
        photoAlt="Wide home elevation lit end to end with permanent LED track lighting"
        eyebrow="Logistics"
