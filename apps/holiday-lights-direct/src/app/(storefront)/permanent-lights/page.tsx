...
export const metadata = {
  title: "Permanent LED Lights & RGBW Track Kits",
  description:
    "Complete 12V permanent LED kits: aluminum track, RGBW pucks, controller, power supply and every connector. Six sizes, 50 to 250 ft.",
