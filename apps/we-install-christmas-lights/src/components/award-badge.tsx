...
export function AwardBadge({ style }: { style?: CSSProperties }) {
  const AWARD_URL = "https://serviceexcellenceawards.ca/winners/mississauga/holiday-christmas-lighting/we-install-christmas-lights-2026";
  const CATEGORY = "Holiday & Christmas Lighting";
