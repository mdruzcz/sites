...
export function ServiceIcon({ name, className = "w-6 h-6" }: { name: string; className?: string }) {
  switch (name) {
    ...
    case "stamp": return <StampIcon className={className} />;
    ...
    case "fence": return <FenceIcon className={className} />;
...
function FenceIcon({ className }: IconProps) {
  return (
    <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 21V8l3-3 3 3v13M10 21V8l3-3 3 3v13M16 21V8l3-3 3 3v13M2 11h22M2 16h22" />
    </svg>
  );
}
