...
export const metadata: Metadata = {
  ...
  description: `Request a free deck or fence quote in Woodstock, Ingersoll, or Tillsonburg. ${site.name} responds within ${site.responseTime}.`,
  openGraph: {
    title: `Get a Free Quote | ${site.name}`,
    description: `Request a free deck or fence quote in Woodstock and Oxford County. We respond within ${site.responseTime}.`,
  },
};
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[var(--charcoal)] text-sm normal-case">Woodstock · Ingersoll · Tillsonburg · Norwich · Embro · Oxford County</p>
                    </div>
                  </li>
                </ul>
              </div>
