      ...
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-[var(--muted)]">
          ...
          <section>
            ...
            <p>Form submissions are stored securely in our database and are accessible only to Celebrate Lighting staff. We retain records for as long as necessary to provide our services and comply with applicable law.</p>
          </section>
