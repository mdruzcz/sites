...
export const metadata: Metadata = {
  title: "Contact Woodstock Deck & Fence | Free Estimate in Woodstock, ON",
  description:
    "Contact Woodstock Deck & Fence for a free on-site estimate. Call 519-914-5697 or fill out our form. We respond within 24 hours. Serving Woodstock, Oxford County, Brantford and Cambridge.",
