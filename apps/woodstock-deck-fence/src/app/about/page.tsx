...
=======
  title: "About Woodstock Deck & Fence | Oxford County Deck & Fence Builders",
  description: "Locally owned Oxford County deck and fence contractors committed to the Woodstock Standard: deep posts, premium materials, and a 5-year workmanship warranty. Serving Woodstock and area.",
  alternates: { canonical: "/about" },
  openGraph: { url: "/about", title: "About Woodstock Deck & Fence", description: "Locally owned deck and fence contractors serving Woodstock and Oxford County." },
>>>>>>> origin/main
};
...
=======
      <section className="pt-32 pb-20 lg:pt-40" style={{ backgroundColor: "var(--forest)" }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm font-semibold uppercase tracking-widest mb-3" style={{ color: "var(--cedar-light)" }}>About Us</p>
          <h1 className="font-serif text-4xl lg:text-5xl font-bold text-white mb-6">Expert Deck &amp; Fence Contractors in Woodstock, ON</h1>
          <p className="text-xl text-white/70 max-w-2xl mx-auto leading-relaxed">Woodstock&apos;s Trusted Deck &amp; Fence Builders — Quality Construction in Oxford County</p>
        </div>
      </section>
...
<<<<<<< HEAD
            ...
            <div className="relative h-80 lg:h-full rounded-2xl overflow-hidden">
              ...
              />
=======
                <p>Woodstock Deck &amp; Fence was founded with a simple mission: to give our neighbours in Woodstock and the surrounding Oxford County area outdoor structures that are as durable as they are beautiful. We saw too many fences leaning after just one Ontario winter and too many decks failing due to poor footings. We decided to do things differently.</p>
                <p>We don&apos;t just build projects — we build the backdrop for your family BBQs, your children&apos;s birthdays, and your summer relaxation. That means every detail matters, from the depth of the post holes to the grade of lumber we specify.</p>
                <p>We&apos;re locally owned and operated. We live where we work, and our reputation in the Woodstock community is our most valuable asset. Every build we complete is a reference for the next homeowner who asks their neighbour: &ldquo;Who built that?&rdquo;</p>
              </div>
            </div>
            <div className="relative h-80 lg:h-full rounded-2xl overflow-hidden min-h-[320px]">
              <Image src="/images/legacy/Custom-Deck-Design-Installation.png" alt="Custom deck construction by Woodstock Deck and Fence in Oxford County, Ontario" fill className="object-cover" />
>>>>>>> origin/main
            </div>
          </div>
        </div>
...
=======
      <section className="py-20 lg:py-28" style={{ backgroundColor: "var(--forest)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative h-80 lg:h-full rounded-2xl overflow-hidden order-2 lg:order-1 min-h-[320px]">
...
=======
              <p className="text-white/70 leading-relaxed mb-8">We believe a deck or fence is only as good as what&apos;s underneath it. In Oxford County, heavy clay soil and deep winter freezes wreak havoc on poorly installed structures. That&apos;s why we hold ourselves to the Woodstock Standard.</p>
              <div className="space-y-5">
                {[
                  { title: "Deep Foundations", desc: "Every post goes 4 feet deep — below Ontario's frost line — guaranteed." },
                  { title: "Local Compliance", desc: "Experts in City of Woodstock by-laws, pool safety codes and Oxford County permits." },
                  { title: "Quality Materials", desc: "Premium lumber and top-tier composites designed to survive the Canadian climate." },
>>>>>>> origin/main
                ].map((s) => (
