...
export const metadata: Metadata = {
  title: "Deck Building Guides &amp; Resources | Woodstock Deck & Fence Blog",
  description:
  ...
  openGraph: {
    url: "/blog",
    title: "Woodstock Deck & Fence Blog",
...
export default function BlogIndex() {
  ...
  return (
    <main>
      ...
      <section className="pt-32 pb-12" style={{ backgroundColor: "var(--forest)" }}>
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-xs font-semibold uppercase tracking-widest px-2.5 py-1 rounded-full" style={{ backgroundColor: "var(--cream-dark)", color: "var(--cedar)" }}>
                      {p.category}
                    </span>
                  ...
                  <h2 className="font-serif text-xl font-bold mb-2 group-hover:underline" style={{ color: "var(--forest)" }}
