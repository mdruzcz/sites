...
export const POSTS: BlogPost[] = [
  {
    ...
    heroAlt: "Composite deck built by Woodstock Deck and Fence, comparing material choices",
    body: [
      {
        type: "p",
  ...
  },
  {
    ...
    title: "The Deck Permit Guide for Woodstock and Oxford County (2026)",
    description:
    ...
    body: [
      ...
      { type: "h2", text: "When you need a permit in Woodstock, Ontario" },
      {
        type: "ul",
        items: [
  ...
  },
  {
    ...
    title: "How Much Does a Deck Really Cost in Woodstock, Ontario? (2026 Pricing)",
    description:
