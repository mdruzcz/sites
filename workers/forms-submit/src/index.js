...
const HOSTNAME_TO_TABLE = {
  ...
  // commercialholidaydecor.ca moved to the ecom back-office (admin.masterdecker.com):
  // it stores quote submissions in ecom_contact_messages, not via this Worker.
