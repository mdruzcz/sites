# Turnstile site keys per site

Each site embeds its assigned `NEXT_PUBLIC_TURNSTILE_SITE_KEY` (public, safe to commit). All sites POST to `https://turnstile.masterdecker.com` for verification. Secrets live only in the Worker.

| Group | Vercel project | Zone | Site key |
|---|---|---|---|
| MD-01 | `allseal-web` | allsealconcretesealing.ca | `0x4AAAAAADXeqV66AiVqKTne` |
| MD-01 | `brantford-concrete-forming` | brantfordconcreteforming.ca | `0x4AAAAAADXeqV66AiVqKTne` |
...
| MD-09 | `ontario-ramp-solutions` | ontariorampsolutions.ca | `0x4AAAAAADXesbgG3_xVYc5b` |
| MD-10 | `optimum-hvac` | optimumhvac.ca | `0x4AAAAAADXesqRDh-_yLbkh` |
| MD-10 | `permanent-lighting-direct` | permanentlightingdirect.ca | `0x4AAAAAADXesqRDh-_yLbkh` |
| MD-10 | `ready-kitchens` | readykitchens.ca | `0x4AAAAAADXesqRDh-_yLbkh` |
| MD-10 | `restore-my-deck` | restoremydeck.ca | `0x4AAAAAADXesqRDh-_yLbkh` |
| MD-11 | `service-excellence-awards` | serviceexcellenceawards.ca | `0x4AAAAAADXes3pUk4chWGDN` |
| MD-11 | `spotless-deck-staining` | spotlessdeckstaining.ca | `0x4AAAAAADXes3pUk4chWGDN` |
...
| Zone | Group | Site key (when project is created) |
|---|---|---|
...
| readysealdirect.ca | MD-10 | `0x4AAAAAADXesqRDh-_yLbkh` |
